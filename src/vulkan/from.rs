...
impl TryAshFrom<PixelFormat> for vk::Format {
    ...
    fn try_ash_from(value: PixelFormat) -> Option<Self> {
        Some(match value {
            ...
            PixelFormat::Bc1RgbUnorm => vk::Format::BC1_RGB_UNORM_BLOCK,
            PixelFormat::Bc1RgbSrgb => vk::Format::BC1_RGB_SRGB_BLOCK,
            PixelFormat::Bc1RgbaUnorm => vk::Format::BC1_RGBA_UNORM_BLOCK,
            PixelFormat::Bc1RgbaSrgb => vk::Format::BC1_RGBA_SRGB_BLOCK,
            PixelFormat::Bc2Unorm => vk::Format::BC2_UNORM_BLOCK,
            PixelFormat::Bc2Srgb => vk::Format::BC2_SRGB_BLOCK,
            PixelFormat::Bc3Unorm => vk::Format::BC3_UNORM_BLOCK,
            PixelFormat::Bc3Srgb => vk::Format::BC3_SRGB_BLOCK,
            PixelFormat::Bc4Unorm => vk::Format::BC4_UNORM_BLOCK,
            PixelFormat::Bc4Snorm => vk::Format::BC4_SNORM_BLOCK,
            PixelFormat::Bc5Unorm => vk::Format::BC5_UNORM_BLOCK,
            PixelFormat::Bc5Snorm => vk::Format::BC5_SNORM_BLOCK,
            _ => return None,
        })
    }
}
...
impl TryFromAsh<vk::Format> for PixelFormat {
    ...
    fn try_from_ash(value: vk::Format) -> Option<Self> {
        Some(match value {
            ...
            vk::Format::BC1_RGB_UNORM_BLOCK => PixelFormat::Bc1RgbUnorm,
            vk::Format::BC1_RGB_SRGB_BLOCK => PixelFormat::Bc1RgbSrgb,
            vk::Format::BC1_RGBA_UNORM_BLOCK => PixelFormat::Bc1RgbaUnorm,
            vk::Format::BC1_RGBA_SRGB_BLOCK => PixelFormat::Bc1RgbaSrgb,
            vk::Format::BC2_UNORM_BLOCK => PixelFormat::Bc2Unorm,
            vk::Format::BC2_SRGB_BLOCK => PixelFormat::Bc2Srgb,
            vk::Format::BC3_UNORM_BLOCK => PixelFormat::Bc3Unorm,
            vk::Format::BC3_SRGB_BLOCK => PixelFormat::Bc3Srgb,
            vk::Format::BC4_UNORM_BLOCK => PixelFormat::Bc4Unorm,
            vk::Format::BC4_SNORM_BLOCK => PixelFormat::Bc4Snorm,
            vk::Format::BC5_UNORM_BLOCK => PixelFormat::Bc5Unorm,
            vk::Format::BC5_SNORM_BLOCK => PixelFormat::Bc5Snorm,
            _ => return None,
        })
    }
}
